            ...
            <Box className={styles.discountBox}>
              ...
              {data.isFourWeek ? (
                <Box className={styles.fourWeekBlock}>
                  <Box className={styles.newPlanBox} >
          ...
          <Box className={`${styles.yourPlanSizeBox} ${className}`}>
            <Box>
              ...
              <p className={styles.terms}>
                ...
                {plan.weeks == 4 ? (
                  <>
                    By continuing you agree that if you don't cancel at least 24 hours prior to the end of the 4 weeks introductory period, you will automatically be charged the full price of {plan.price} every month until you cancel in settings. Learn more about cancellation and refund policy in
                  </>
                ) : (<></>
                )}
                {plan.weeks > 10 ? (
